...
namespace manage
{
    public partial class form_everonmentview : Form
    {
        ...
        private void form_everonmentview_Load(object sender, EventArgs e)
        {
            ...
            System.Timers.Timer t = new System.Timers.Timer(500);       //每500ms刷新一次
       ...
       /// <param name="e"></param>
        ...
        private void SetData1()
        {
            ...
            {
                //101温度传感器
                mysql_1.Tables[0].Rows[0][1] = (float.Parse(f1.numlist1[0]) - 2.5).ToString("#0.0"); //数值  
                mysql_1.Tables[0].Rows[0][2] = f1.templ+ "°C" + "-"+ f1.temph+ "°C"; //正常范围
                ...
                //湿度传感器
                mysql_1.Tables[0].Rows[1][1] = (float.Parse(f1.numlist2[0]) + 1.9).ToString("#0.0"); //数值  
                mysql_1.Tables[0].Rows[1][2] = f1.wetl + "%" + "-" + f1.weth + "%"; //正常范围
                ...
                //102温度传感器
                mysql_2.Tables[0].Rows[0][1] = (float.Parse(f1.numlist1[1]) - 3.6).ToString("#0.0"); //数值
                mysql_2.Tables[0].Rows[0][2] = f1.templ + "°C" + "-" + f1.temph + "°C"; //正常范围
                ...
                //湿度传感器
                mysql_2.Tables[0].Rows[1][1] = (float.Parse(f1.numlist2[1]) + 7).ToString("#0.0"); //数值
                mysql_2.Tables[0].Rows[1][2] = f1.wetl + "%" + "-" + f1.weth + "%"; //正常范围
